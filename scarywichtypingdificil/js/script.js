...
class Modelo{
    constructor(){
        ...
        "enciclopedia", "libreta", "papelera", "oficina", "papeleta", "esternocleidomastoideo",
        "otorrinolaringologo", "paralelepipedo", "caleidoscopio", "ovoviviparo", "guardacostas", "guardameta", "	rompecabezas"
        , "lavavajillas", "	sacapuntas", "limpiaparabrisas"];
        this.puntuacion=0;
        this.vidas=3;
    }
    crearPalabra(){
